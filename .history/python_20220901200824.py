...
def ['modality_inperson'] =


df['ANY_50$_TRANSACTION'] = df['acc_no'].isin(
    df.loc[df['trans_amount'].eq(50), 'acc_no'])

school_learn_mod['modality_inperson'] = school_learn_mod.apply(
    lambda row: create_id(), axis=1)
