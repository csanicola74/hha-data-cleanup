...
# load in the School Learning Modalities csv file
...
school_learn_mod['modality_inperson'] = np.where(
    school_learn_mod["Learning_Modality"] == 'In Person', True, False)

# confirm the new column and that it is a boolean
school_learn_mod.dtypes

# save the clean version to a new csv file
